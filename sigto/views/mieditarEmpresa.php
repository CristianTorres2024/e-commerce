...
<body>
    ...
    <form action="../sigto/index.php?action=edit_profile2&idemp=<?php echo $empresa['idemp']; ?>" method="post">
    <h1>Editar Empresa</h1>
        ...
        <br><br><br>
        <a id="volver" href="/sigto/views/empresaperfil.php">Volver al perfil</a>
    </form>
